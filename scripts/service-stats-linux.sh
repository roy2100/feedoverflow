...
#
# Usage:
#   ./scripts/service-stats-linux.sh            # active log only
#   ./scripts/service-stats-linux.sh --all      # also include gzipped rotated archives (chronological)
#   LOG_DIR=/some/path ./scripts/service-stats-linux.sh
#
# In-place Linux deploy: logs land in the repo's own logs/ dir (logger.ts defaults to
# ../logs relative to server/). Override with LOG_DIR.
